...
import { Plus, Search, Filter, Camera, Trash2, Edit2 } from "lucide-react";
...
export default function Inventory() {
  const { inventory, removeItem } = useStore();
  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pb-20">
        <button className="aspect-[3/4] rounded-2xl border-2 border-dashed border-white/10 hover:border-primary/50 hover:bg-primary/5 transition-all flex flex-col items-center justify-center gap-3 group">
