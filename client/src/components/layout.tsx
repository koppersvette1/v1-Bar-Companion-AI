...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-orange-500 selection:text-white pb-24 md:pb-0">
      ...
      <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 px-4 py-3 flex items-center justify-between md:hidden safe-area-inset-top">
        <Link href="/" className="text-xl font-serif font-bold tracking-tight text-orange-500 flex items-center gap-2 active:scale-95 transition-transform p-1 -m-1">
        ...
        <div className="flex items-center gap-1">
          {!user && (
            <Button
              size="sm"
              className="bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white text-xs min-h-[44px] px-4 active:scale-95 transition-transform"
          ...
          <Link href="/settings" className="p-3 rounded-full hover:bg-white/5 active:bg-white/10 transition-all active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col md:flex-row max-w-7xl mx-auto w-full">
        ...
        <main className="flex-1 px-4 py-6 md:p-8 overflow-y-auto min-h-screen">
      ...
      {/* Mobile Bottom Nav - Enhanced for Touch */}
      <nav className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-slate-800 pb-safe md:hidden z-50 safe-area-inset-bottom">
